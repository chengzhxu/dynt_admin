...
class PictureModel extends Model {
    ...
    protected $tableName = 'common_picture';
     ...
     */
    public function upload($files, $setting, $driver = '', $config = null) {
        /* 上传文件 */
//        $setting['callback'] = array($this, 'isFile');
        ...
        if ($info) { //文件上传成功，记录文件信息
            foreach ($info as $key => &$value) {
                ...
                } elseif (strtolower($driver) == 'oss') {//阿里Oss
                    $oss_config = C('UPLOAD_TYPE_CONFIG');
                    $value['path'] = $oss_config['url'].$value['savepath'] . $value['savename'];
                } else {
